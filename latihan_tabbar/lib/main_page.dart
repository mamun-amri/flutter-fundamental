...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const _TextStyle = TextStyle(fontSize: 30, fontWeight: FontWeight.bold);

    const List<Widget> _bottomNavigationOptions = [
      Text("Home", style: _TextStyle),
      Text("Location", style: _TextStyle),
      Text("Box", style: _TextStyle),
      Text("History", style: _TextStyle),
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
                        ...
                        child: Flexible(
                          child: Row(children: [
                            Flexible(
                                flex: 2,
                                child: buildRow(
                                    black, "Plastation", "assets/4.jpg")),
                            Flexible(
                                flex: 3,
                                child: buildRow(
                                    black, "Earphone", "assets/5.jpg")),
                          ]),
                        ),
                      ),
                      Container(
            ...
            _bottomNavigationOptions.elementAt(_selectedIndex),
          ],
        ),
        // navigasi bawah
        bottomNavigationBar: BottomNavigationBar(
          items: [
            BottomNavigationBarItem(
                icon: Icon(Icons.home_outlined, color: black), label: "Home"),
            BottomNavigationBarItem(
                icon: Icon(Icons.location_on_outlined, color: black),
                label: "Location"),
            BottomNavigationBarItem(
                icon: Icon(Icons.add_box_outlined, color: black), label: "Box"),
            BottomNavigationBarItem(
                icon: Icon(Icons.history_outlined, color: black),
                label: "History"),
            BottomNavigationBarItem(
                icon: Icon(Icons.person_outline, color: black),
                label: "Account"),
          ],
